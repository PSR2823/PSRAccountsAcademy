...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    ...
    <div class="bg-white p-12 shadow-2xl rounded-lg text-center max-w-2xl">
        ...
        <!-- Success Message -->
        <h1 class="text-4xl font-bold text-gray-700 mt-8">Changed Your Password Successfully</h1>
        
         
        <!-- Buttons -->
        <div class="mt-10">
            <a href="studentlogin" class="w-full block text-center bg-blue-500 text-white py-4 rounded-md hover:bg-blue-600 transition-all">
             Go To Login Page
            </a>
        </div>
    </div>
