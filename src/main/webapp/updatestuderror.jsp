...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    ...
    <div class="bg-white p-10 shadow-lg rounded-lg text-center max-w-lg">
        ...
        <!-- Error Message -->
        <h1 class="text-3xl font-bold text-red-600 mt-6">Profile Update Failed</h1>
        <p class="text-black font-semibold text-lg mt-4">
            We encountered an issue while Updating Your Profile. <br>       
        </p>
        ...
        <p class="text-red-700 font-bold text-xl text-lg mt-4">
          Note: (All Fields must be Filled)
        </p>

        <!-- Back to Payment Button -->
        <div class="mt-8">
            <a href="updatestudentprofile" class="w-full block text-center bg-blue-500 text-white py-3 rounded-md hover:bg-blue-600 transition-all">
